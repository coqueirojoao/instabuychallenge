...
export default function ColdCutsAndDairy() {
  ...
  const [ColdCutsAndDairyItems, setColdCutsAndDairyItems] = useState();

  useEffect(() => {
    const getColdCutsAndDairyItems = () => {
      if (allProducts) {
        const data = allProducts.collection_items[2];
        setColdCutsAndDairyItems(data);
      }
    };
    getColdCutsAndDairyItems();
  }, [allProducts]);
